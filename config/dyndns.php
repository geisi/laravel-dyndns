...
return [
    ...
    'domains' => [
        ...
        /*
         * The public IP Address Discover Service. By default, we are using the opendns.com resolver to query the current public IP address.
         ...
         */
        'discover_service' => Geisi\DynDns\Services\OpenDNSPublicIPResolver::class,
        /*
